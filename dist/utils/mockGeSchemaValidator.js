...
exports.MockGESchemaValidator = void 0;
class MockGESchemaValidator {
    /**
     * Mock schema validation - analyzes data structure without Python
     */
    static validateSchema(tableName, data) {
     ...
     */
    static compareSchemas(tableName, sourceData, targetData) {
    ...
    static getMandatoryFields(tableName) {
...
exports.MockGESchemaValidator = MockGESchemaValidator;
